...
def extract_ai_usage(repo_dir: str):
    ...
    try:
        ...
        print("Analysis completed. Extracting structured data...")
        
        # Step 2: Extract structured data from analysis
        analysis_data = extract_analysis_data(analysis_result)

        print("Usage extraction completed successfully.")
        # print("\nFinal JSON Output:")
...
def extract_analysis_data(analysis: str):
        ...
        "properties": {
            ...
            "use_cases": {
                ...
                "items": {
                    ...
                    "required": ["name", "functionality", "ai_confidence_score", "input_data", "output_data", "files_involved"]
                }
            }
        },
    ...
    try:
        ...
        print(f"Debug - Structured data keys: {structured_data.keys() if isinstance(structured_data, dict) else 'Not a dict'}")
...
def main():
    ...
    try:
        print("Starting usage extraction...")
        structured_data = extract_ai_usage("./repos/finding/")
